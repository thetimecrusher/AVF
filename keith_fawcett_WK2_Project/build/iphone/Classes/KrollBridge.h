...
@interface keith_fawcett_WK2_ProjectObject : KrollCoverageObject {
#else
@interface keith_fawcett_WK2_ProjectObject : KrollObject {
#endif
@private
...
extern NSString * keith_fawcett_WK2_Project$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	keith_fawcett_WK2_ProjectObject *_keith_fawcett_wk2_project;
    KrollObject* console;
	BOOL shutdown;
