...
//@interface keith_fawcett_WK2_ProjectObject : NSObject
//@end

@interface keith_fawcett_WK2_ProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[keith_fawcett_WK2_ProjectObject class]])
		{
			for (NSString *key in [[(keith_fawcett_WK2_ProjectObject*)o modules] allKeys])
			{
