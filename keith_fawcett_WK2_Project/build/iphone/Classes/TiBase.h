...
// in simulator we redefine to format for keith_fawcett_WK2_Project Developer console
...
{\
	NSString * exceptionName = [@"org.keith_fawcett_wk2_project." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.keith_fawcett_wk2_project";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIkeith_fawcett_WK2_ProjectNativeItemNone = -1, 
	UIkeith_fawcett_WK2_ProjectNativeItemSpinner = -2,
	UIkeith_fawcett_WK2_ProjectNativeItemProgressBar = -3,
	
	UIkeith_fawcett_WK2_ProjectNativeItemSlider = -4,
	UIkeith_fawcett_WK2_ProjectNativeItemSwitch = -5,
	UIkeith_fawcett_WK2_ProjectNativeItemMultiButton = -6,
	UIkeith_fawcett_WK2_ProjectNativeItemSegmented = -7,
	
	UIkeith_fawcett_WK2_ProjectNativeItemTextView = -8,
	UIkeith_fawcett_WK2_ProjectNativeItemTextField = -9,
	UIkeith_fawcett_WK2_ProjectNativeItemSearchBar = -10,
	
	UIkeith_fawcett_WK2_ProjectNativeItemPicker = -11,
	UIkeith_fawcett_WK2_ProjectNativeItemDatePicker = -12,
	
	UIkeith_fawcett_WK2_ProjectNativeItemInfoLight = -13,
	UIkeith_fawcett_WK2_ProjectNativeItemInfoDark = -14,
	
	UIkeith_fawcett_WK2_ProjectNativeItemDisclosure = -15,
	
	UIkeith_fawcett_WK2_ProjectNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all keith_fawcett_WK2_Project instances of
