...
@interface keith_fawcett_WK3_ProjectObject : KrollCoverageObject {
#else
@interface keith_fawcett_WK3_ProjectObject : KrollObject {
#endif
@private
...
extern NSString * keith_fawcett_WK3_Project$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	keith_fawcett_WK3_ProjectObject *_keith_fawcett_wk3_project;
    KrollObject* console;
	BOOL shutdown;
