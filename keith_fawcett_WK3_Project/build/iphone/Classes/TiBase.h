...
// in simulator we redefine to format for keith_fawcett_WK3_Project Developer console
...
{\
	NSString * exceptionName = [@"org.keith_fawcett_wk3_project." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.keith_fawcett_wk3_project";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIkeith_fawcett_WK3_ProjectNativeItemNone = -1, 
	UIkeith_fawcett_WK3_ProjectNativeItemSpinner = -2,
	UIkeith_fawcett_WK3_ProjectNativeItemProgressBar = -3,
	
	UIkeith_fawcett_WK3_ProjectNativeItemSlider = -4,
	UIkeith_fawcett_WK3_ProjectNativeItemSwitch = -5,
	UIkeith_fawcett_WK3_ProjectNativeItemMultiButton = -6,
	UIkeith_fawcett_WK3_ProjectNativeItemSegmented = -7,
	
	UIkeith_fawcett_WK3_ProjectNativeItemTextView = -8,
	UIkeith_fawcett_WK3_ProjectNativeItemTextField = -9,
	UIkeith_fawcett_WK3_ProjectNativeItemSearchBar = -10,
	
	UIkeith_fawcett_WK3_ProjectNativeItemPicker = -11,
	UIkeith_fawcett_WK3_ProjectNativeItemDatePicker = -12,
	
	UIkeith_fawcett_WK3_ProjectNativeItemInfoLight = -13,
	UIkeith_fawcett_WK3_ProjectNativeItemInfoDark = -14,
	
	UIkeith_fawcett_WK3_ProjectNativeItemDisclosure = -15,
	
	UIkeith_fawcett_WK3_ProjectNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all keith_fawcett_WK3_Project instances of
