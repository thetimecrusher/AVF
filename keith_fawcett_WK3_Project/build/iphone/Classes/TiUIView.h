...
/**
 Base class for all keith_fawcett_WK3_Project views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the keith_fawcett_WK3_Project view hierarchy (such as wrapped iOS UIViews) was touched.
