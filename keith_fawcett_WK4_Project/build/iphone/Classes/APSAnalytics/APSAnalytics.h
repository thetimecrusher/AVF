 ...
 * to send analytic data that can be viewed on the keith_fawcett_WK4_Project Dashboard.
 *
 * For information on getting started with keith_fawcett_WK4_Project Platform Services,
