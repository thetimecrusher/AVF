...
@interface keith_fawcett_WK4_ProjectObject : KrollCoverageObject {
#else
@interface keith_fawcett_WK4_ProjectObject : KrollObject {
#endif
@private
...
extern NSString * keith_fawcett_WK4_Project$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	keith_fawcett_WK4_ProjectObject *_keith_fawcett_wk4_project;
    KrollObject* console;
	BOOL shutdown;
