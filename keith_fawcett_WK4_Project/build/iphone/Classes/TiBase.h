...
// in simulator we redefine to format for keith_fawcett_WK4_Project Developer console
...
{\
	NSString * exceptionName = [@"org.keith_fawcett_wk4_project." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.keith_fawcett_wk4_project";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIkeith_fawcett_WK4_ProjectNativeItemNone = -1, 
	UIkeith_fawcett_WK4_ProjectNativeItemSpinner = -2,
	UIkeith_fawcett_WK4_ProjectNativeItemProgressBar = -3,
	
	UIkeith_fawcett_WK4_ProjectNativeItemSlider = -4,
	UIkeith_fawcett_WK4_ProjectNativeItemSwitch = -5,
	UIkeith_fawcett_WK4_ProjectNativeItemMultiButton = -6,
	UIkeith_fawcett_WK4_ProjectNativeItemSegmented = -7,
	
	UIkeith_fawcett_WK4_ProjectNativeItemTextView = -8,
	UIkeith_fawcett_WK4_ProjectNativeItemTextField = -9,
	UIkeith_fawcett_WK4_ProjectNativeItemSearchBar = -10,
	
	UIkeith_fawcett_WK4_ProjectNativeItemPicker = -11,
	UIkeith_fawcett_WK4_ProjectNativeItemDatePicker = -12,
	
	UIkeith_fawcett_WK4_ProjectNativeItemInfoLight = -13,
	UIkeith_fawcett_WK4_ProjectNativeItemInfoDark = -14,
	
	UIkeith_fawcett_WK4_ProjectNativeItemDisclosure = -15,
	
	UIkeith_fawcett_WK4_ProjectNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all keith_fawcett_WK4_Project instances of
