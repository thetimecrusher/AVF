...
/**
 The base class for all keith_fawcett_WK4_Project modules
 */
...
/**
 keith_fawcett_WK4_Project Platform calls this method on startup.
 */
-(void)startup;

/**
 keith_fawcett_WK4_Project Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 keith_fawcett_WK4_Project Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 keith_fawcett_WK4_Project Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 keith_fawcett_WK4_Project Platform calls this method on resume.
 @param sender The sender of the event.
 */
