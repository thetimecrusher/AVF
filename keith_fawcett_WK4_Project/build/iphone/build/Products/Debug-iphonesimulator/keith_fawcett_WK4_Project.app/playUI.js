...
exports.buildPlayUI = function(songs){
...
var back = Ti.UI.createLabel({
	...
	top: "6%",
	left: "5%",
	font: {fontSize: 24, fontFamily: "Arial", fontStyle: "Underline"}
});
...
var title = Ti.UI.createLabel({
	text: songs[0].genre.toUpperCase(),
	color: "#000",
	top : "5%",
...
favorite.addEventListener("click", function(){
	sql.anyData = true;
	sql.saveData(songs[currentSong]);
	arrowDB.save(songs[currentSong]);
	alert(songs[currentSong].title + " has been added to your favorites");
	//favorite.text = "In Favorites";
});
